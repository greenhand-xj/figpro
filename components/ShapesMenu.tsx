          ...
          {item.value.map((elem) => (
            <DropdownMenuItem key={elem?.name}>
              <Button
                ...
                className={`flex h-fit w-full justify-between gap-10 rounded-none px-5 py-3 focus:border-none ${activeElement.value === elem?.value ? "bg-primary-green" : "hover:bg-primary-grey-200"
                  }`}
              >
